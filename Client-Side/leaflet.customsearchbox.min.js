...
function generateHtmlContent(a) {
    ...
    b += '<li class="panel-list-item d-flex justify-content-center pt-4">' +
            "<div>City:  </div>" + '<img src="https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-violet.png" width="25" height="41" margin-right="30"><br>' +
            "<div>County:  </div>" + '<img src="https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-yellow.png" width="25" height="41" margin-right="30"><br>' +
            "<div>State:  </div>" + '<img src="https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-green.png" width="25" height="41" margin-right="30"><br>' +
            "<div>Country:  </div>" + '<img src="https://cdn.rawgit.com/pointhi/leaflet-color-markers/master/img/marker-icon-2x-blue.png" width="25" height="41" margin-right="30"><br>' +
        ' </li>'
    return b + "</ul>"
}
