...
function generateHtmlContent(a) {
    ...
    if ( a.Items[0].type == "checkbox" ) {
        b +=' <li class="panel-list-item d-flex justify-content-center pt-0 pb-2">' +
            ' <div class="d-flex justify-content-center">' +
                ' <select id="scale" class="col-lg-4 col-lg-offset-4 py-1" style="width:1000px">' +
        ...
        b +=' <li class="panel-list-item d-flex justify-content-center pt-0 pb-2">' +
                ' <div class="d-flex justify-content-center">' +
                    ' <select id="dropDown" class="col-lg-4 col-lg-offset-4 py-1" style="width:1000px"> </select>' +
                ' </div>' +
            '</li>'
    }
    ...
    for (d = 0; d < a.Items.length; d++) {
        ...
        if ( c.type == "search" ) {
            b +=' <li class="panel-list-item d-flex justify-content-center pt-0 pb-2">' +
                ' <div class="divSelectSearch d-flex justify-content-center">' +
                    ' <select id="scale'+ d +'" class="col-lg-4 col-lg-offset-4 py-1">' +
                    '<option id="1" value="nation"> Nation </option>' +
                    '<option id="2" value="state"> State </option>' +
                    '<option id="3" value="county"> County </option>' +
                    '<option id="4" value="city"> City </option>' +
        ...
        "search" == c.type ? (b += '<div class="autocomplete"><input id="' + c.id + '" class="compareSearch bg-white col-lg-4 col-lg-offset-4 py-1" type="text" placeholder="Select Location ' + (d + 1) + '"> </div>') :
        //Add checkbox
