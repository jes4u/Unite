...
function generateHtmlContent(a) {
    ...
    b +=' <li class="panel-list-item d-flex justify-content-center pt-0 pb-2">' +
            ' <div class="d-flex justify-content-center">' +
                ' <select id="scale" class="col-lg-4 col-lg-offset-4 py-1" style="width:350px">' +
    ...
    b +=' <li class="panel-list-item d-flex justify-content-center pt-0 pb-2">' +
            ' <div class="d-flex justify-content-center">' +
                ' <select id="dropDown" class="col-lg-4 col-lg-offset-4 py-1" style="width:350px" placeholder="Location Results"> </select>' +
            ' </div>' +
          '</li>'
    ...
    for (d = 0; d < a.Items.length; d++) {
        ...
        "search" == c.type ? (b += '<input class="compareSearch bg-white col-lg-4 col-lg-offset-4 py-1" type="text" placeholder="Select Location ' + (d + 1) + '">') :
        //Add checkbox
