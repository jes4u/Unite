                        ...
                        ' <span class="panel-header-title"> ' + 
                            '<div id="controlboxInner" > ' + 
                                '<div id="boxcontainerInner" class="searchbox searchbox-shadow" > ' + 
                                    ...
                                    ' </div> ' + 
                                    ' <div> ' + 
                                        ' <input id="searchboxinputInner" type="text" style="position: relative;"/> ' + 
                                    ' </div> ' + 
                                    ' <div class="searchbox-searchbutton-container"> ' + 
...
function generateHtmlContent(a) { 
    ...
    //Add Submit button
    b += '<li class="panel-list-item d-flex justify-content-center">' +
            '<button type="button" class="m-*-auto btn-light px-4" onclick="submitValues()" >' +
                'Submit' +
            '</button>' +
        ' </li>'
    return b + "</ul>" 
